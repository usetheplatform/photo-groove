...
var $author$project$PhotoFolders$photoDecoder = A2(
	$elm$json$Json$Decode$map,
...
function $author$project$PhotoFolders$cyclic$folderDecoder() {
	return A3(
		...
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'photos',
			$author$project$PhotoFolders$photoDecoder,
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'name',
				$elm$json$Json$Decode$string,
...
var $author$project$PhotoGallery$initalCmd = $elm$http$Http$get(
	{
		expect: A2(
...
var $author$project$PhotoGallery$init = function (flags) {
	var activity = 'Initializing Past v' + $elm$core$String$fromFloat(flags);
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$PhotoGallery$initialModel,
			{activity: activity}),
		$author$project$PhotoGallery$initalCmd);
};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return A2(
			...
			url,
			{key: key, page: $author$project$Main$NotFound, version: flags});
	});
...
var $author$project$PhotoGallery$applyFilters = function (model) {
	...
	switch (_v0.$) {
		case 'Loaded':
			...
			var cmd = $author$project$PhotoGallery$setFilters(
					...
					if (photos.b) {
						...
						return $author$project$PhotoGallery$applyFilters(
							_Utils_update(
								model,
								{
									status: A2($author$project$PhotoGallery$Loaded, photos, x.url)
								}));
					} else {
						return _Utils_Tuple2(
							_Utils_update(
	...
	function (photos, selectedUrl, chosenSize, model) {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3($author$project$PhotoGallery$viewFilter, $author$project$PhotoGallery$SlideHue, 'Hue', model.hue),
						A3($author$project$PhotoGallery$viewFilter, $author$project$PhotoGallery$SlideRipple, 'Ripple', model.ripple),
						A3($author$project$PhotoGallery$viewFilter, $author$project$PhotoGallery$SlideNoise, 'Noise', model.noise)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('sizes')
					]),
				_List_fromArray(
					[
						A2(
						...
						A2(
							$elm$core$List$map,
							$author$project$PhotoGallery$viewSizeChooser(chosenSize),
							_List_fromArray(
