...
var $author$project$PhotoGroove$initalCmd = $elm$http$Http$get(
	{
		expect: A2(
...
var $author$project$PhotoGroove$init = function (flags) {
	...
	return _Utils_Tuple2(
		_Utils_update(
			...
			{activity: activity}),
		$author$project$PhotoGroove$initalCmd);
};
...
var $author$project$PhotoGroove$viewLoaded = F4(
		...
		function () {
			...
			switch (_v0.$) {
				case 'Loaded':
					var photos = _v0.a;
					var selectedUrl = _v0.b;
					return A4($author$project$PhotoGroove$viewLoaded, photos, selectedUrl, model.chosenSize, model);
				case 'Loading':
					return _List_Nil;
				default:
